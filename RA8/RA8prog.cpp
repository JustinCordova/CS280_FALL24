...
int main(int argc, char *argv[])
{
	...
	// Create a vector of Value objects
    /*vector<Value> vals;
    vals.push_back(ErrorVal);
    vals.push_back(intVal1);
    vals.push_back(intVal2);
    vals.push_back(doubleVal1);
    vals.push_back(doubleVal2);
    vals.push_back(StrVal1);
    vals.push_back(StrVal2);
    vals.push_back(chVal1);
    vals.push_back(chVal2);
    vals.push_back(bVal1);
    vals.push_back(bVal2);*/
